...
Source0  : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.5.0/paho.mqtt.cpp-1.5.0.tar.gz
...
%prep
%setup -q -n paho.mqtt.cpp-1.5.0
cd %{_builddir}/paho.mqtt.cpp-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736348514
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpaho-mqttpp3.so.1.5.0
