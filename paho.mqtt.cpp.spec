...
Source0  : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1545510280
...
/usr/lib64/libpaho-mqttpp3.so.1.0.1
