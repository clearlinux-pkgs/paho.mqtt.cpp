...
Source0  : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.5.2/paho.mqtt.cpp-1.5.2.tar.gz
...
%prep
%setup -q -n paho.mqtt.cpp-1.5.2
cd %{_builddir}/paho.mqtt.cpp-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741742300
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpaho-mqttpp3.so.1.5.1
