...
Source0  : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.3.2/paho.mqtt.cpp-1.3.2.tar.gz
...
%prep
%setup -q -n paho.mqtt.cpp-1.3.2
cd %{_builddir}/paho.mqtt.cpp-1.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701974300
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpaho-mqttpp3.so.1.3.2
