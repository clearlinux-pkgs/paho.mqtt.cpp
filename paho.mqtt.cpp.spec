...
Version  : 1.5.1
Release  : 11
URL      : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.5.1/paho.mqtt.cpp-1.5.1.tar.gz
Source0  : https://github.com/eclipse/paho.mqtt.cpp/archive/v1.5.1/paho.mqtt.cpp-1.5.1.tar.gz
...
%prep
%setup -q -n paho.mqtt.cpp-1.5.1
cd %{_builddir}/paho.mqtt.cpp-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739155161
mkdir -p clr-build
pushd clr-build
